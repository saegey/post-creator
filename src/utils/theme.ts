...
export default {
  ...
  colors: {
    ...
    backgroundLight: lighten(palette.white, 0.04),
    background: palette.white,
    backgroundDark: darken(palette.white, 0.04),
    ...
    surfaceLight: palette.grayLight,
    ...
    modes: {
      dark: {
        ...
        backgroundLight: lighten(palette.grayDarkest, 0.04),
        backgroundDark: darken(palette.grayDarkest, 0.04),
        backgroundOpaque: "rgba(0, 0, 0, 0.7)",
        backgroundTransparent: "rgba(255, 255, 255, 0.1)",
        text: palette.white,
        ...
        surfaceLight: palette.grayDarkness,
