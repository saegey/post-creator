...
const EmbedIcon = ({ sx }: { sx?: ThemeUIStyleObject | undefined }) => {
  return (
    <IconButton sx={sx}>
      <svg
        height="100%"
      ...
      >
        <g>
          <path
            fill="currentcolor"
            d="M153.527,138.934c-0.29,0-0.581,0.088-0.826,0.258L0.641,242.995C0.238,243.27,0,243.721,0,244.213v27.921
		...
		c0.403-0.282,0.641-0.734,0.641-1.226V140.41c0-0.548-0.298-1.049-0.782-1.299C153.995,138.991,153.765,138.934,153.527,138.934z"
          ...
          <path
            fill="currentcolor"
            d="M511.358,242.995l-152.06-103.803c-0.246-0.169-0.536-0.258-0.827-0.258c-0.238,0-0.467,0.056-0.685,0.177
		...
		C512,243.721,511.762,243.27,511.358,242.995z"
          ...
          <path
            fill="currentcolor"
            d="M325.507,114.594h-42.502c-0.629,0-1.186,0.395-1.387,0.984l-96.517,279.885
