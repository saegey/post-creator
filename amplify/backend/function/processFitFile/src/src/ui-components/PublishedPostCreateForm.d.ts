...
export declare type PublishedPostCreateFormInputValues = {
    title?: string;
    gpxFile?: string;
    images?: string;
    headerImage?: string;
...
export declare type PublishedPostCreateFormValidationValues = {
...
export declare type PublishedPostCreateFormOverridesProps = {
    PublishedPostCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type PublishedPostCreateFormProps = React.PropsWithChildren<{
    overrides?: PublishedPostCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: PublishedPostCreateFormInputValues) => PublishedPostCreateFormInputValues;
    onSuccess?: (fields: PublishedPostCreateFormInputValues) => void;
    onError?: (fields: PublishedPostCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: PublishedPostCreateFormInputValues) => PublishedPostCreateFormInputValues;
    onValidate?: PublishedPostCreateFormValidationValues;
} & React.CSSProperties>;
export default function PublishedPostCreateForm(props: PublishedPostCreateFormProps): React.ReactElement;
