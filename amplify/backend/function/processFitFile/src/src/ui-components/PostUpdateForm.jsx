...
export default function PostUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPrivacyStatus(cleanValues.privacyStatus);
    setErrors({});
  };
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.privacyStatus ?? value;
          }
          if (errors.privacyStatus?.hasError) {
            runValidationTasks("privacyStatus", value);
          }
          setPrivacyStatus(value);
        }}
        onBlur={() => runValidationTasks("privacyStatus", privacyStatus)}
        errorMessage={errors.privacyStatus?.errorMessage}
        hasError={errors.privacyStatus?.hasError}
        {...getOverrideProps(overrides, "privacyStatus")}
      ></TextField>
      <Flex
