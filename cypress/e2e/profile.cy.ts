...
describe("Profile", () => {
  ...
  beforeEach(() => {
    ...
    cy.signIn("adam.saegebarth@gmail.com", "yy*Em*jTLfw2v@6o_").then(() => {
  ...
  it("should load profile page", () => {
    ...
    cy.get("#fullName", { timeout: 10000 }).should("have.value", "Adam S");

    // The username should be correct
    cy.get("#username", { timeout: 10000 }).should("have.value", "saegey");
    // cy.get("#username").contains("saegey");

    // The new page should contain an h1 with "About page"
    cy.get("#location", { timeout: 10000 }).should("have.value", "Seattle, WA");
