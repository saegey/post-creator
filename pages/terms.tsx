    ...
    <>
      ...
      >
        ...
        >
          ...
          <Text as="h2">AGREEMENT TO OUR LEGAL TERMS</Text>
          <Text as="p">
            We are Napkin Service, doing business as Monopad LLC ("Company,"
            "we," "us," "our"), a company registered in Washington at 1719 NW
            58th St.
          </Text>
          <Text as="p">
            We operate the website http://monopad.app (the "Site"), as well as
            ...
            can contact us by email at ceo@monoapp.app.
          </Text>
          <Text as="p">
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("you"),
            and Napkin Service, concerning your access to and use of the
          ...
          <Text as="p">
            ...
            effective upon posting or notifying you by privacy@monopad.app, as
          ...
          <Box as="ol" sx={{ marginLeft: "30px" }}>
            <Box as="li">
              <ThemeLink href="#services">OUR SERVICES</ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#intellectual-property">
                INTELLECTUAL PROPERTY RIGHTS
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#user-representations">
                USER REPRESENTATIONS
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#user-registration">USER REGISTRATION</ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#purchases-and-payment">
                PURCHASES AND PAYMENT
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#cancellation">CANCELLATION </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#prohibited-activities">
                PROHIBITED ACTIVITIES
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#user-generated-contributions">
                USER GENERATED CONTRIBUTIONS
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#contribution-license">
                CONTRIBUTION LICENSE
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#social-media">SOCIAL MEDIA </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#third-party-websites-and-content">
                THIRD-PARTY WEBSITES AND CONTENT
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#services-management">
                SERVICES MANAGEMENT
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#privacy-policy">PRIVACY POLICY </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#copyright-infringements">
                COPYRIGHT INFRINGEMENTS
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#term-and-termination">
                TERM AND TERMINATION
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#modifications-and-interruptions">
                MODIFICATIONS AND INTERRUPTIONS
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#governing-law">GOVERNING LAW</ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#dispute-resolution">
                DISPUTE RESOLUTION
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#corrections">CORRECTIONS </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#disclaimer">DISCLAIMER </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#limitations-of-liability">
                LIMITATIONS OF LIABILITY
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#indemnification">INDEMNIFICATION </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#user-data">USER DATA </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#electronic-communications">
                ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#california-users-and-residents">
                CALIFORNIA USERS AND RESIDENTS
              </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#miscellaneous">MISCELLANEOUS </ThemeLink>
            </Box>
            <Box as="li">
              <ThemeLink href="#contact-us">CONTACT US</ThemeLink>
            </Box>
          </Box>
          <Text as="h2" id="services">
            1. OUR SERVICES
          </Text>
          <Text as="p">
          ...
          <Text as="h2" id="intellectual-property">
            2. INTELLECTUAL PROPERTY RIGHTS
          </Text>
          <Text as="h3">Our intellectual property</Text>
          <Text as="p">
          ...
          <Text as="h3">Your use of our Services</Text>
          <Text as="p">
          ...
          >
            <Text as="li">access the Services; and</Text>
            <Text as="li">
              download or print a copy of any portion of the Content to which
              you have properly gained access.
            </Text>
          </Box>
          <Text as="p">solely for your personal, non-commercial use.</Text>
          <Text as="p">
          ...
          <Text as="p">
            ...
            please address your request to: ceo@monoapp.app. If we ever grant
          ...
          <Text as="h3">Your submissions and contributions</Text>
          <Text as="p">
          ...
          <Text as="p">
            <Text sx={{ fontWeight: "600" }}>Submissions: </Text>By directly
          ...
          <Text as="p">
            <Text sx={{ fontWeight: "600" }}>Contributions: </Text>The Services
          ...
          >
            ...
            <Text as="li">
              ...
              warrant that any such Submission and/or Contributions are to
            ...
            <Text as="li">
              ...
              do not constitute confidential information. You are solely
              responsible for your Submissions and/or Contributions and you
          ...
          <Text as="h3" id="copyright-infringement">
          ...
          <Text as="h2" id="user-representations">
          ...
          <Text as="h2" id="user-registration">
            4. USER REGISTRATION
          </Text>
          <Text as="p">
          ...
          <Text as="h2" id="purchases-and-payment">
            5. PURCHASES AND PAYMENT
          </Text>
          <Text as="p">We accept the following forms of payment: </Text>
          <Text as="p">
          ...
          <Text as="p">
            ...
            paid term. If you are unsatisfied with our Services, please email us
            at ceo@monoapp.app.
          </Text>
          <Text as="h2" id="prohibited-activities">
          ...
          <Text as="p">As a user of the Services, you agree not to:</Text>
          <Box
            as="ul"
            sx={{
              marginLeft: "15px",
          ...
          >
            ...
            <Text as="li">Sell or otherwise transfer your profile.</Text>
          </Box>
          <Text as="h2" id="user-generated-contributions">
          ...
          <Text as="h2" id="contribution-license">
          ...
          <Text as="h2" id="third-party-websites-and-content">
          ...
          <Text as="h2" id="services-management">
          ...
          <Text as="h2" id="copyright-infringements">
          ...
          <Text as="h2" id="term-and-termination">
          ...
          <Text as="h2" id="modifications-and-interruptions">
          ...
          <Text as="h2" id="dispute-resolution">
          ...
          <Text as="h2" id="limitations-of-liability">
          ...
          <Text as="p">
            ...
            ARISING OR $10.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS
          ...
          <Text as="h2" id="electronic-communications">
          ...
          <Text as="h2" id="california-users-and-residents">
          ...
          <Text as="p">Napkin Service __________ ceo@monoapp.app</Text>
        </Flex>
      </Flex>
    </>
  );
